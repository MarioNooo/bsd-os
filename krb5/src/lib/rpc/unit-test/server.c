 ...
 *
 * server.c,v 1.1.1.1 2003/08/14 15:54:08 polk Exp
 * /master/krb5/src/lib/rpc/unit-test/server.c,v
 */

#if !defined(lint) && !defined(__CODECENTER__)
static char *rcsid = "/master/krb5/src/lib/rpc/unit-test/server.c,v 1.1.1.1 2003/08/14 15:54:08 polk Exp";
#endif
