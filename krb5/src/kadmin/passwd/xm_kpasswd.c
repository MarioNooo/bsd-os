 ...
 * 
 * /master/krb5/src/kadmin/passwd/xm_kpasswd.c,v 1.1.1.1 2003/08/14 15:53:23 polk Exp
 *
 *
 */

static char rcsid_2[] = "xm_kpasswd.c,v 1.1.1.1 2003/08/14 15:53:23 polk Exp";
