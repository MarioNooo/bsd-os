...
#if defined (IS_CALL_INSN)
/* Legacy for systems yet to multi-arch IS_CALL_INSN */
#if !defined (IS_CALL_INSN_P)
#define IS_CALL_INSN_P() (1)
#endif
#endif

/* Default predicate for non- multi-arch targets. */
#if (!GDB_MULTI_ARCH) && !defined (IS_CALL_INSN_P)
#define IS_CALL_INSN_P() (0)
#endif

extern int gdbarch_is_call_insn_p (struct gdbarch *gdbarch);
#if (GDB_MULTI_ARCH > GDB_MULTI_ARCH_PARTIAL) && defined (IS_CALL_INSN_P)
#error "Non multi-arch definition of IS_CALL_INSN"
#endif
#if (GDB_MULTI_ARCH > GDB_MULTI_ARCH_PARTIAL) || !defined (IS_CALL_INSN_P)
#define IS_CALL_INSN_P() (gdbarch_is_call_insn_p (current_gdbarch))
#endif

/* Default (function) for non- multi-arch platforms. */
#if (!GDB_MULTI_ARCH) && !defined (IS_CALL_INSN)
#define IS_CALL_INSN(pc) (internal_error (__FILE__, __LINE__, "IS_CALL_INSN"), 0)
#endif

typedef int (gdbarch_is_call_insn_ftype) (CORE_ADDR pc);
extern int gdbarch_is_call_insn (struct gdbarch *gdbarch, CORE_ADDR pc);
extern void set_gdbarch_is_call_insn (struct gdbarch *gdbarch, gdbarch_is_call_insn_ftype *is_call_insn);
#if (GDB_MULTI_ARCH > GDB_MULTI_ARCH_PARTIAL) && defined (IS_CALL_INSN)
#error "Non multi-arch definition of IS_CALL_INSN"
#endif
#if GDB_MULTI_ARCH
#if (GDB_MULTI_ARCH > GDB_MULTI_ARCH_PARTIAL) || !defined (IS_CALL_INSN)
#define IS_CALL_INSN(pc) (gdbarch_is_call_insn (current_gdbarch, pc))
#endif
#endif
