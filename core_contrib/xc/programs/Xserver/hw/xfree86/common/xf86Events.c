...
#else
#ifdef BSDI_VT
            ioctl(xf86Info.consoleFd, PCCONIOCSWTCH, &vtno);
#else
...
#if defined(linux) || (defined(CSRG_BASED) && (defined(SYSCONS_SUPPORT) || defined(PCVT_SUPPORT) || defined(WSCONS_SUPPORT))) || defined(SCO) || defined(BSDI_VT)
	/*
