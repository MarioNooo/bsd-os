...
struct host_info {
    ...
    struct sockaddr *sa;		/* socket address or 0 */
...
extern int ipv6_addr();			/* get/verify an IPv6 address */
extern int get_masklen();		/* get/verify a netmask length */
