/*	BSDI string.h,v 1.5 2000/05/03 02:14:18 torek Exp	*/
...
extern inline char * _dl_strcpy(char * dest0,const char *src)
{
	char *dest = dest0;
__asm__("cld\n"
	"1:\tlodsb\n\t"
...
extern inline void * _dl_memcpy(void * to0, const void * from, size_t n)
{
	char *to = to0;
__asm__("cld\n\t"
	"movl %%edx, %%ecx\n\t"
...
extern inline void * _dl_memset(void * s0,char c,size_t count)
{
	char *s = s0;
__asm__("cld\n\t"
	"rep\n\t"
