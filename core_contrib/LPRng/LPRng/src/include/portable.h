 ...
 * $Id: portable.h,v 5.9 2000/04/14 20:40:32 papowell Exp papowell $
 ***************************************************************************/
...
#if !(defined(HAVE_KRB_H) || defined(HAVE_KERBEROSIV_KRB_H)) && defined(MIT_KERBEROS4)
# error - you want MIT_KERBEROS4 and you do not have the krb.h support
#endif
#if (defined(HAVE_KRB_H) || defined(HAVE_KERBEROSIV_KRB_H)) && defined(MIT_KERBEROS4)
# undef KRB4_STUFF
# define KRB4_STUFF 1
