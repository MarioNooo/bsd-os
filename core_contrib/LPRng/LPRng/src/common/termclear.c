...
"$Id: termclear.c,v 5.6 2000/04/14 20:51:29 papowell Exp papowell $";
...
#if defined(HAVE_TERMCAP_H) || defined(HAVE_CURSES_H) || defined(HAVE_NCURSES_H) || defined(HAVE_TERM_H)
...
#   include <ncurses.h>
# else
#   if defined(HAVE_CURSES_H) || defined(SOLARIS)
#     if defined(SOLARIS) && SOLARIS >= 270
#      define	_WIDEC_H
#      define	_WCHAR_H
#     endif
#     include <curses.h>
...
#if (defined(IS_BSDI) && IS_BSDI <= 401) || defined(HPUX)
#undef PPUTS_RETTYPE
#undef PPUTS_RETVAL
