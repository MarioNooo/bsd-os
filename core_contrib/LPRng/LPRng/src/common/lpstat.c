...
"$Id: lpstat.c,v 5.9 2000/04/14 20:40:02 papowell Exp papowell $";
...
*/
	...
	for( i = 1; i < argc; ++i ){
		...
		if(DEBUGL1){
			logDebug("D_flag %d, d_flag %d, r_flag %d, R_flag %d, s_flag %d, t_flag %d, l_flag %d, P_flag %d",
				D_flag, d_flag, r_flag, R_flag, s_flag, t_flag, l_flag, P_flag );
