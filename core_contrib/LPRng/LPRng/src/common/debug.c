...
"$Id: debug.c,v 5.4 2000/04/14 20:39:50 papowell Exp papowell $";
...
struct keywords debug_vars[]		/* debugging variables */
 = {
    ...
    { "lpr",FLAG_K,(void *)&DbgFlag,DRECV1, DRECVMASK },
    { "lpr+1",FLAG_K,(void *)&DbgFlag,DRECV1, DRECVMASK },
    { "lpr+2",FLAG_K,(void *)&DbgFlag,DRECV2|DRECV1, DRECVMASK },
    { "lpr+3",FLAG_K,(void *)&DbgFlag,DRECV3|DRECV2|DRECV1, DRECVMASK },
    { "lpr+4",FLAG_K,(void *)&DbgFlag,DRECV4|DRECV3|DRECV2|DRECV1, DRECVMASK },
    { "lpc",FLAG_K,(void *)&DbgFlag,DCTRL1, DCTRLMASK },
    { "lpc+1",FLAG_K,(void *)&DbgFlag,DCTRL1, DCTRLMASK },
    { "lpc+2",FLAG_K,(void *)&DbgFlag,DCTRL2|DCTRL1, DCTRLMASK },
    { "lpc+3",FLAG_K,(void *)&DbgFlag,DCTRL3|DCTRL2|DCTRL1, DCTRLMASK },
    { "lpc+4",FLAG_K,(void *)&DbgFlag,DCTRL4|DCTRL3|DCTRL2|DCTRL1, DCTRLMASK },
