/*	BSDI libiberty.h,v 1.2 2003/06/02 12:48:43 torek Exp	*/
...
#if defined (__GNU_LIBRARY__ ) || defined (__linux__) || defined (__FreeBSD__) || defined (__OpenBSD__) || defined(__bsdi__) || defined (__CYGWIN__) || defined (__CYGWIN32__) || defined (HAVE_DECL_BASENAME)
