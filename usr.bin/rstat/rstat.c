/*	BSDI rstat.c,v 2.3 1996/07/18 21:03:30 jch Exp	*/
...
char **argv;
{
    ...
    printf(" %2d:%02d%cm  up %s%s load average: %.2f %.2f %.2f\n",
        ...
        days_buf,
        hours_buf,
        (double)host_stat->avenrun[0]/RSTAT_FSCALE,
        (double)host_stat->avenrun[1]/RSTAT_FSCALE,
        (double)host_stat->avenrun[2]/RSTAT_FSCALE);
