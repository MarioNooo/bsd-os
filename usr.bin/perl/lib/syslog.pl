#
# syslog.pl
#	BSDI	syslog.pl,v 1.3 1997/01/14 22:20:44 sanders Exp
#
# syslog.pl,v
# Revision 1.3  1997/01/14 22:20:44  sanders
# fixed the socket structure layout (notably, syslog was failing)
#
# Revision 1.2  1995/01/04 17:37:23  polk
# support LOG_PERROR option
#
# Revision 1.1.1.1  1992/07/27  23:24:57  polk
...
sub main'syslog {
    ...
    print STDERR "<$facility.$priority>$whoami: $message\r" if $lo_perror;
