...
**
**	RCSID do_uuxqt.c,v 2.2 1996/06/11 19:27:35 vixie Exp
**
**	do_uuxqt.c,v
**	Revision 2.2  1996/06/11 19:27:35  vixie
**	2.2
**	
**	Revision 2.1  1995/02/03 13:22:52  polk
**	Update all revs to 2.1
**
 * Revision 1.4  1995/01/30  18:17:38  donn
 * Patch from Paul Vixie to avoid core dumps for null commands.
 *
...
getlegalcmds()
{
	...
	else
	{
		...
		while ( (cp = GetLine(&bufp, true)) != NULLSTR )
		{
			register char *	sp;
