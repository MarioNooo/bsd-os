...
**
**	RCSID CheckUserPath.c,v 2.2 1996/06/11 19:26:56 vixie Exp
**
**	CheckUserPath.c,v
**	Revision 2.2  1996/06/11 19:26:56  vixie
**	2.2
**	
**	Revision 2.1  1995/02/03 13:17:32  polk
...
empty:
	...
	for ( dp = buf ; (cp = GetLine(&dp, false)) != NULLSTR ; )
	{
