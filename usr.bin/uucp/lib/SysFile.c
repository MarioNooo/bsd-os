...
**
**	RCSID SysFile.c,v 2.2 1998/09/22 05:39:26 torek Exp
**
**	SysFile.c,v
**	Revision 2.2  1998/09/22 05:39:26  torek
**	The usual "time_t vs long" (remove bogus casts)
**	
 * Revision 2.1  1995/02/03  13:19:06  polk
 * Update all revs to 2.1
 *
 * Revision 1.2  1995/01/08  07:48:17  donn
 * Some changes from Paul Vixie.
 *
 * Revision 1.1  1994/12/28  06:04:15  vixie
 * ckp
 *
...
static int	time_cmp(const void *, const void *);
...
)
{
	...
	SetTimes();
	tp = localtime(&Time);	/* Used by check_time() */
