...
/*
**	RCSID InitParams.c,v 2.2 1996/06/11 19:27:02 vixie Exp
**
**	InitParams.c,v
**	Revision 2.2  1996/06/11 19:27:02  vixie
**	2.2
**	
**	Revision 2.1  1995/02/03 13:18:24  polk
...
)
{
	...
	for ( ;; )
	{
		if ( (dp = GetLine(bufp, false)) == NULLSTR )
			return NULLSTR;
