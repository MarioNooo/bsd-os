...
**	File manipulation.
**
**	RCSID Create.c,v 2.2 1996/06/11 19:26:57 vixie Exp
**
**	Create.c,v
**	Revision 2.2  1996/06/11 19:26:57  vixie
**	2.2
**	
**	Revision 2.1  1995/02/03 13:17:38  polk
...
#	endif	/* O_CREAT */
		if ( errno != ENOENT || !CheckDirs(file) )
...
)
{
	...
	while ( link(name1, name2) == SYSERROR )
		if ( errno != ENOENT || !CheckDirs(name2) )
