...
**
**	RCSID do_cico.c,v 2.3 1999/04/19 17:28:57 polk Exp
**
**	do_cico.c,v
**	Revision 2.3  1999/04/19 17:28:57  polk
**	remove bogus decl of inet_ntoa)
**	
**	Revision 2.2  1996/09/18 18:15:39  vixie
**	fixed bug found during testing on gw.home.vix.com.
**	
**	Revision 2.1  1995/02/03 13:21:33  polk
**	Update all revs to 2.1
**
 * Revision 1.6  1995/01/08  07:48:55  donn
 * Some changes from Paul Vixie.
 *
 * Revision 1.1  1994/12/28  06:19:29  vixie
 * Initial revision
 *
...
static StatusType
ss_fail() {
	if (Stats.byts_sent || Stats.byts_rcvd)
		return (SS_HALFWAY);
	return (SS_FAIL);
}
