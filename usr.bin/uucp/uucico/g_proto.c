...
**
**	RCSID g_proto.c,v 2.1 1995/02/03 13:21:38 polk Exp
**
**	g_proto.c,v
**	Revision 2.1  1995/02/03 13:21:38  polk
**	Update all revs to 2.1
**	
 * Revision 1.4  1995/01/08  07:49:00  donn
...
)
{
	...
	*p = hdchk;
	...
	if ( x < 0 )
	{
		...
		{
			(void)alarm(0);
			Log(PkErr, "write:", strerror(errno));
			pktfail();
		}
	}
	else
