...
**
**	RCSID do_uux.c,v 2.1 1995/02/03 13:22:40 polk Exp
**
**	do_uux.c,v
**	Revision 2.1  1995/02/03 13:22:40  polk
**	Update all revs to 2.1
**	
 * Revision 1.2  1995/01/08  07:49:14  donn
 * Some changes from Paul Vixie.
 *
 * Revision 1.1  1994/12/28  06:19:37  vixie
 * Initial revision
 *
	...
	char *	filename;
{
	...
	{
		Debug((1, "Could not stat \"%s\": %s", filename,
		       strerror(errno)));
		return;
	}
