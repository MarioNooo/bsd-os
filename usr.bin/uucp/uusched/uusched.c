...
**
**	uusched.c,v
**	Revision 2.2  1996/06/11 19:27:33  vixie
**	2.2
**	
**	Revision 2.1  1995/02/03 13:22:31  polk
**	Update all revs to 2.1
**
 * Revision 1.4  1995/01/08  07:49:06  donn
 * Some changes from Paul Vixie.
 *
 * Revision 1.1  1994/12/28  06:19:36  vixie
 * Initial revision
 *
...
static char	rcsid[]	= "uusched.c,v 2.2 1996/06/11 19:27:33 vixie Exp";
