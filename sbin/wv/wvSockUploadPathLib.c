...
--------------------
02k,13sep00,tcr  update documentation
02j,27sep99,dvs  changed mallocs/frees to KHEAP_ALLOC/KHEAP_FREE
...
This library is configured into the system by including the
INCLUDE_WVUPLOAD_SOCK component.

INCLUDE FILES: wvSockUploadPathLibP.h
...
UPLOAD_ID sockUploadPathCreate 
    ...
    if ((pSockUploadDesc = (SOCK_UPLOAD_DESC *)
                           KHEAP_ALLOC (sizeof (SOCK_UPLOAD_DESC))) == NULL)
        {
