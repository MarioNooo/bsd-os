...
--------------------
01h,13sep00,tcr  update documentation
01g,27sep99,dvs  changed mallocs/frees to KHEAP_ALLOC/KHEAP_FREE
...
INCLUDE_WVUPLOAD_FILE component.

INCLUDE FILES: wvFileUploadPathLibP.h
...
UPLOAD_ID fileUploadPathCreate 
    ...
    if ((pFileUploadDesc = (FILE_UPLOAD_DESC *)
                           KHEAP_ALLOC (sizeof (FILE_UPLOAD_DESC))) == NULL)
        {
