 ...
 *
 *      BSDI devs.h,v 2.4 1997/09/10 19:07:55 sanders Exp
 */
...
struct cdfuncs {
	...
	int	__P((*load)(struct cdinfo *));
	int	__P((*pause)(struct cdinfo *, int));
};
...
int	scsi2_load __P((struct cdinfo *));
int	scsi2_pause __P((struct cdinfo *, int));
...
int	panasonic_pause __P((struct cdinfo *, int));
...
int	toshiba_pause __P((struct cdinfo *, int));
...
int	mitsumi_pause __P((struct cdinfo *, int));

struct cdinfo *make_cdinfo __P((int, int));
int	scsi_inquiry __P((int, char *, char *, char *, int *));
int	scsi_cmd __P((int, u_char *, int, u_char *, int));
int	scsi_cmd_write __P((int, u_char *, int,  u_char *, int));
int	scsi_cmd_read __P((int, u_char *, int, u_char *, int));
