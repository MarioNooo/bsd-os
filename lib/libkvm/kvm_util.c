 ...
 *
 *	BSDI kvm_util.c,v 2.3 1997/11/20 17:17:29 torek Exp
 */
 ...
 */
int
_kvm_sys2(kvm_t *kd, int *mib, char *l2name, void *addr, size_t size)
{
	size_t s;
 ...
 */
void *
_kvm_s2alloc(kvm_t *kd, int *mib, char *l2name, size_t *np, size_t units)
{
	size_t s;
	void *p;
