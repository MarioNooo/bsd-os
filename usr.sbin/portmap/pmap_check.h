/*	BSDI pmap_check.h,v 2.2 1998/02/13 01:00:46 don Exp */
...
#else
#define CHECK_SETUNSET(xprt,ludp,ltcp,proc,prog,check_port,port) \
	check_setunset(svc_getcaller(xprt),proc,prog,check_port,port)
#endif
