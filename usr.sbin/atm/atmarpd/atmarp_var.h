 ...
 * All rights reserved.
 *
 *	@(#) atmarp_var.h,v 1.6 1998/08/13 20:11:12 johnc Exp
 *
 */
 ...
 */
#ifdef	__bsdi__
#define	ATMARP_DIR			_PATH_VARRUN
#else
#define	ATMARP_DIR			"/tmp"
#endif
#define	ATMARP_SOCK_PREFIX		"AA_"
#define	ATARP_CACHE_INTERVAL		50
#define	ATARP_PERM_INTERVAL		600
#define	ATARP_KEEPALIVE_INTERVAL	5
