 ...
 * All rights reserved.
 *
 *	@(#) atmarpd.c,v 1.5 1998/08/13 20:11:13 johnc Exp
 *
 */
...
#ifndef lint
static char *RCSid = "@(#) atmarpd.c,v 1.5 1998/08/13 20:11:13 johnc Exp";
#endif
...

{
	 ...
	 */
	HARP_TIMER(&cache_timer, ATARP_CACHE_INTERVAL,
			atmarp_cache_timeout);

	/*
	 * Start the permanent cache entry timer
	 */
	HARP_TIMER(&perm_timer, ATARP_PERM_INTERVAL,
			atmarp_perm_timeout);
