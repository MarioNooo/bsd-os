 ...
 * All rights reserved.
 *
 *	@(#) atmarp_subr.c,v 1.6 1998/08/13 20:11:11 johnc Exp
 *
 */
...
#ifndef lint
static char *RCSid = "@(#) atmarp_subr.c,v 1.6 1998/08/13 20:11:11 johnc Exp";
#endif
	...
	Atmarp_intf	*aip;
{
	...
	ip_addr = &netif_rsp->anp_proto_addr.sin;
	...
	if (aip->ai_state != AI_STATE_NULL &&
			bcmp((caddr_t) &netif_rsp->anp_proto_addr.sin.sin_addr,
	 ...
	 */
	aip->ai_ip_addr = netif_rsp->anp_proto_addr.sin.sin_addr;
...
{
	int			rc;
	struct sockaddr_in	*ipp = &cp->aap_arp_addr.sin;
	Atmarp_intf		*aip;
	Atmarp			*aap;
