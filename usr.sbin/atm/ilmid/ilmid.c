 ...
 *
 *      @(#) ilmid.c,v 1.4 1998/11/24 16:41:49 jch Exp
 *
 */
...
#ifndef	lint
static char *RCSid = "@(#) ilmid.c,v 1.4 1998/11/24 16:41:49 jch Exp";
#endif
	...
	Snmp_Header	*hdr;
{
	...
	sin = &net_info->anp_proto_addr.sin;
