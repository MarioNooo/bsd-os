 ...
 * All rights reserved.
 *
 *	@(#) atm.c,v 1.17 1998/08/06 16:57:47 johnc Exp
 *
 */
...
#ifndef lint
static char *RCSid = "@(#) atm.c,v 1.17 1998/08/06 16:57:47 johnc Exp";
#endif
	...
	struct cmd	*cmdp;
{
	...
	apr.adr_arp_dst.sa = host_addr.sa;
