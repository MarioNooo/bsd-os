 ...
 * All rights reserved.
 *
 *	@(#) atm_show.c,v 1.12 1998/07/24 16:20:34 johnc Exp
 *
 */
...
#ifndef lint
static char *RCSid = "@(#) atm_show.c,v 1.12 1998/07/24 16:20:34 johnc Exp";
#endif
 ...
 * Local functions
 */
static int	vcc_compare __P((char *, char *));
static int	ip_vcc_compare __P((char *, char *));
static int	arp_compare __P((char *, char *));
	...
	struct cmd	*cmdp;
{
	...
	air.air_arp_addr.sa = host_addr.sa;
	...
	qsort((char *) arp_info,
			...
			sizeof(struct air_arp_rsp), arp_compare);
	...
	struct cmd	*cmdp;
{
	...
	air.air_ip_addr.sa = host_addr.sa;
	...
	qsort((char *) ip_info,
			...
			sizeof(struct air_ip_vcc_rsp), ip_vcc_compare);
	...
	struct cmd	*cmdp;
{
	...
	qsort((char *) vcc_info,
			...
			sizeof(struct air_vcc_rsp), vcc_compare);
	...
	char *p1, *p2;
{
	...
	sin1 = &c1->aap_arp_addr.sin;
	sin2 = &c2->aap_arp_addr.sin;
